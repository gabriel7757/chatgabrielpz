...
function configureSocket(socket) {
  ...
  socket.on('all online users', function (users) {
    ...
    {
      var htmluser='<div class="' + users[i]._id + '" online-user">' + users[i]._id + '</div>';
    }
  ...
  socket.on('new user', function (nuser) {
   	//var linuser='<div class="online-user ' + nuser._id +'">'+nuser._id+'</div>'; original
	var linuser='<div class="online-user ' + nuser._id +'">'+nuser._id+
	    '<img src="imagenes/fotes.png" class="user-image"></div>'; 
